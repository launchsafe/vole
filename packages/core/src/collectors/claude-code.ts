...
import { readNewLines, parseLine, count, sumCounts } from '../util/jsonl';
...
function toEvent(
  ...
  return {
    ...
    ...tokens,
    reasoning_tokens: count(usage.output_tokens_details?.thinking_tokens),
    total_tokens: sumCounts(input, output, w5m, w1h, read),
