...
const DOCUMENTS = [
  ...
  { file: 'docs/SYSTEM-OVERVIEW.md', title: 'System overview', blurb: 'One self-contained read: what the product is, how the data flows, and every language, framework and tool it is built from.' },
  { file: 'docs/RECENT-CHANGES.md', title: 'Recent changes',  blurb: 'The eleven commits on the current branch — seven bug fixes, the third confidence tier, and the Cursor token work.' },
